...
/*
   ...
   compile: g++ -c -pipe -O3 -fomit-frame-pointer -march=core2   nbody.gpp-2.c++ -o nbody.gpp-2.c++.o &&  \
   g++ nbody.gpp-2.c++.o -o nbody.gpp-2.gpp_run
   run: ./nbody.gpp-2.gpp_run 50000000
*/
...
public:
            ...
            }}
	{
        ...
        std::cout << std::setprecision(9) << energy() << '\n';
        for (int l=0; l<n; ++l) {
            // bodies.advance(0.01);
