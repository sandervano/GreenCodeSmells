...
/* Edited by Sander van Oostveen
   compile: javac -d .  nbody_smell.java
   run: java   nbody_smell 50000000
*/

public final class nbody_smell {
   public static void main(String[] args) {
      int n = Integer.parseInt(args[0]);

      NBodySystem bodies = new NBodySystem(n);
   }
